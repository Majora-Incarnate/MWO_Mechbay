 ...
 * @author Nemesis
 */
public class EquipmentDialogBox extends javax.swing.JDialog implements MechCommon
{
    String temp;
    
    public EquipmentDialogBox(java.awt.Frame parent, boolean modal, Weapon weapon)
    {
        super(parent, modal);
        initComponents();
